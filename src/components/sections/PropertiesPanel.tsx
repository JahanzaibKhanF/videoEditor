...
import { MousePointerClick, VolumeX, Volume2, Film, Droplets, ImageIcon, Sparkles, Shuffle, SlidersHorizontal } from "@/utils/icons";
            ...
            return (
              <div className={panel}>
                ...
                <div className={panelBody}>
                  ...
                  <button
                    onClick={() => setBgRemovalClipId(selectedClipId)}
                    className="w-full flex items-center justify-center gap-1.5 py-2 rounded-lg border border-studio-border text-ink-secondary text-[12px] font-bold hover:bg-studio-hover hover:border-signal/40 transition-colors"
                  >
