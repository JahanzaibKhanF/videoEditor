...
export default function PropertiesPanel() {
  ...
  const panel = "bg-studio-raised border border-studio-border rounded-xl overflow-hidden";
  const panelHeader = "flex items-center gap-2 px-3.5 py-2.5 border-b border-studio-border";
  const panelBody = "p-3.5 flex flex-col gap-3";
