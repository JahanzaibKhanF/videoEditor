    ...
    <div className={`startup-overlay${closing ? " closing" : ""}`}>
      ...
      <div className="relative flex flex-col items-center w-[96vw] max-w-[900px]" style={{ zIndex: 1 }}>
        ...
        <div className="flex items-center gap-3 sm:gap-4 mb-2 sm:mb-3">
          <div className="w-11 h-11 sm:w-14 sm:h-14 rounded-2xl flex items-center justify-center flex-shrink-0"
          ...
          <h1 className="text-white font-extrabold tracking-tight leading-none text-[36px] sm:text-[52px] md:text-[60px]"
        ...
        <div className="text-center mt-4 sm:mt-6 px-4 max-w-[640px]">
          ...
          <p className="text-[11px] sm:text-[12.5px] leading-relaxed mt-1" style={{ color: "rgba(255,255,255,.35)" }}>
            Trim, layer, and animate clips, apply CapCut-style templates with speed ramps and color grading,
