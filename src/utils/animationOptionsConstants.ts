// Import specific React Icons
import {
  FaBan, // None
  FaArrowLeft, // Slide In (Left)
  FaArrowUp, // Slide Up
  FaArrowDown, // Slide Down
  FaEye, // Fade In
  FaEyeSlash, // Fade Out
  FaSearchPlus, // Zoom In
  FaArrowsAltH, // Mirror In (horizontal flip)
  FaSyncAlt, // Rotate In
  FaExpandAlt, // Grow
  FaCompressAlt, // Shrink
  FaHeartbeat, // Pulse (Continuous)
  FaMeteor, // Bounce In
  FaExchangeAlt, // Flip In (X)
  FaExchangeAlt as FaExchangeAltVertical, // Flip In (Y) - using alias
  FaHandPointUp, // Flip Bounce In
  FaCloud, // Blur In
  FaLongArrowAltLeft, // Slide In (Left & Fade)
  FaExpandArrowsAlt, // Scale & Rotate In
  FaRocket, // Light Speed In
  FaFolderPlus, // Fold In
  FaFolderOpen, // Unfold Out

  // --- New Icons for additional animations ---
  FaArrowRight, // Slide In (Right)
  FaCaretUp, // Pop In (Up)
  FaCaretDown, // Pop In (Down)
  FaCrosshairs, // Target Zoom
  FaTimesCircle, // Explode Out
  FaMagic, // Twirl In
  FaCompress, // Squeeze In
  FaExpand, // Stretch Out
  FaWaveSquare, // Wave In
  FaBolt, // Flash In
  FaCircleNotch, // Spin In
  FaStar, // Bling In
  FaSun, // Glow In
  FaMinusSquare, // Collapse
  FaPlusSquare, // Expand (opposite of collapse)
  FaBezierCurve, // Smooth In
  FaUndo, // Rewind In
  FaRedo, // Fast Forward Out
  FaHourglassHalf, // Slow Fade
  FaGraduationCap, // Reveal Up
  FaMask, // Mask Reveal
  FaDolly, // Slide From Top
  FaTruckLoading, // Slide From Bottom
  FaLightbulb, // Flicker
  FaPuzzlePiece, // Jigsaw In
  FaSpinner, // Loading Spin (Continuous)
  FaEllipsisH, // Dots Fade
  FaBars, // Stagger In
  FaClipboardList, // Typewriter
  FaLink, // Chain Reaction
  FaShareAlt, // Disperse
  FaCubes, // Stack In
  FaDraftingCompass, // Draw In
} from "react-icons/fa"; // Ensure you import all used icons from 'react-icons/fa'
