...
export function useProjectAutosave() {
  const { user } = useAuth();
  const {
    clipsDetails, textsDetails, imagesDetails, blursDetails, audioDetails,
  ...
  }), [clipsDetails, textsDetails, imagesDetails, blursDetails, audioDetails, layerOrder, selectedAspectRatio, totalTime, fps, videos]);
  ...
  }, [clipsDetails, textsDetails, imagesDetails, blursDetails, audioDetails, layerOrder, selectedAspectRatio, user, save]);
